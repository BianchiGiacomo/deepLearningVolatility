...
class LeakyClamp(Module):
    ...
    .. seealso::
        - :func:`deepLearningVolatility.nn.functional.leaky_clamp`
    ...
    Examples:
        >>> import torch
        >>> from deepLearningVolatility.nn import LeakyClamp
        >>> m = LeakyClamp()
...
class Clamp(Module):
    ...
    .. seealso::
        - :func:`torch.clamp`
        - :func:`deepLearningVolatility.nn.functional.clamp`
    ...
    Examples:
        ...
        >>> import torch
        >>> from deepLearningVolatility.nn import Clamp
        >>>
        >>> m = Clamp()
        >>> input = torch.linspace(-2, 12, 15) * 0.1
        >>> input
