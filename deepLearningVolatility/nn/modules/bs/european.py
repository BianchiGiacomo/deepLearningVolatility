...
from deepLearningVolatility._utils.bisect import find_implied_volatility
from deepLearningVolatility._utils.doc import _set_attr_and_docstring
from deepLearningVolatility._utils.str import _format_float
from deepLearningVolatility.instruments import EuropeanOption
...
from deepLearningVolatility.nn.functional import bs_european_theta
from deepLearningVolatility.nn.functional import bs_european_vega
...
class BSEuropeanOption(BSModuleMixin):
    ...
    .. seealso::
        - :class:`deepLearningVolatility.nn.BlackScholes`:
    ...
    Examples:
        >>> import torch
        >>> from deepLearningVolatility.nn import BSEuropeanOption
        >>>
        >>> m = BSEuropeanOption()
        >>> m.inputs()
    ...
    def from_derivative(cls, derivative: EuropeanOption) -> "BSEuropeanOption":
        ...
        Args:
            derivative (:class:`deepLearningVolatility.instruments.EuropeanOption`):
        ...
        Examples:
            >>> from deepLearningVolatility.instruments import BrownianStock
            >>> from deepLearningVolatility.instruments import EuropeanOption
            >>>
