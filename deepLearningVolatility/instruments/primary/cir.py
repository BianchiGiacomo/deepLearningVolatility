...
from deepLearningVolatility.stochastic import generate_cir
...
class CIRRate(BasePrimary):
    ...
    .. seealso::
        - :func:`deepLearningVolatility.stochastic.generate_cir`:
    ...
    Examples:
        >>> from deepLearningVolatility.instruments import CIRRate
        ...
