...
from deepLearningVolatility.stochastic import generate_kou_jump
...
class KouJumpStock(BasePrimary):
    ...
    .. seealso::
        - :func:`deepLearningVolatility.stochastic.generate_kou_jump`:
    ...
    Examples:
        >>> from deepLearningVolatility.instruments import KouJumpStock
        >>>
