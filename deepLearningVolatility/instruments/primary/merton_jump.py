...
from deepLearningVolatility.stochastic import generate_merton_jump
...
class MertonJumpStock(BasePrimary):
    ...
    .. seealso::
        - :func:`deepLearningVolatility.stochastic.generate_merton_jump`:
    ...
    Examples:
        >>> from deepLearningVolatility.instruments import MertonJumpStock
        >>>
