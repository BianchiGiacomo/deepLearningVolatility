...
from deepLearningVolatility.stochastic import generate_heston
...
class HestonStock(BasePrimary):
    ...
    .. seealso::
        - :func:`deepLearningVolatility.stochastic.generate_heston`:
    ...
    Examples:
        >>> from deepLearningVolatility.instruments import HestonStock
        >>>
