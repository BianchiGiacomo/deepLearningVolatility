...
from deepLearningVolatility.stochastic import generate_vasicek
...
class VasicekRate(BasePrimary):
    ...
    .. seealso::
        - :func:`deepLearningVolatility.stochastic.generate_vasicek`:
    ...
    Examples:
        >>> from deepLearningVolatility.instruments import VasicekRate
        ...
