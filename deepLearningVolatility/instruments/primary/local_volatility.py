...
from deepLearningVolatility._utils.doc import _set_docstring
from deepLearningVolatility._utils.str import _format_float
from deepLearningVolatility._utils.typing import LocalVolatilityFunction
from deepLearningVolatility._utils.typing import TensorOrScalar
from deepLearningVolatility.stochastic import generate_local_volatility_process
...
class LocalVolatilityStock(BasePrimary):
    ...
    .. seealso::
        - :func:`deepLearningVolatility.stochastic.generate_local_volatility_process`:
    ...
    def simulate(
        ...
        Examples:
            >>> from deepLearningVolatility.instruments import LocalVolatilityStock
            ...
