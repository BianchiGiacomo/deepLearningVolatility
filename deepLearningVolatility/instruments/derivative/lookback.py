...
from deepLearningVolatility.nn.functional import lookback_payoff
...
class LookbackOption(BaseDerivative, OptionMixin):
    ...
    .. seealso::
        - :func:`deepLearningVolatility.nn.functional.lookback_payoff`
    ...
    Examples:
        ...
        >>> from deepLearningVolatility.instruments import LookbackOption
        >>>
