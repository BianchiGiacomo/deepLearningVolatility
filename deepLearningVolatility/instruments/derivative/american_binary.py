...
from deepLearningVolatility.nn.functional import american_binary_payoff
...
class AmericanBinaryOption(BaseDerivative, OptionMixin):
    ...
    .. seealso::
        - :func:`deepLearningVolatility.nn.functional.american_binary_payoff`
    ...
    Examples:
        ...
        >>> from deepLearningVolatility.instruments import AmericanBinaryOption
        >>>
